...
| Related Concepts | Structure (designed), Diversity (designed), Nature (designed), Discovery (designed) |
...
| Mapping Source | plants_dandelion |
| IB Theme | How the World Works (primary, weight=0.40) |
| Dimension Anchors | appearance — shape (physical — "round seed head, fluffy puff ball" drives the wonder and collection criterion), senses — texture (physical — "soft, light, airy" adds sensory depth to detail-harvesting questions), imagination (engagement — "what does it remind you of?" drives naming and story synthesis) |
| Conversation Anchor Dimensions | appearance — shape ("round fluffy seed head"), senses — texture ("soft and light like a tiny cloud") |
...
> **Conversation anchor**: appearance — shape ("round fluffy seed head"); senses — texture ("soft and light like a tiny cloud")
>
> **AI says**: *(warm, building on earlier)* "You noticed how round and fluffy this dandelion is! So soft, like a tiny cloud. I wonder what other interesting things are hiding in this park..."
>
> **Possible child responses**:
> 1. (Ideal) "Let's find some!" / "I see something!" / child starts looking around
> 2. (Unexpected) "I want to blow it!" / "It's so pretty!" / child touches the dandelion
> 3. (No response) Child looks at the dandelion or the screen quietly.
>
> **AI follow-up**:
> 1. *(excited)* "Yes! Let's go exploring! This fluffy puff ball is just the beginning — I bet there are more amazing things to find!"
> 2. *(playful)* "It IS so pretty and soft! And you know what? I bet there are more cool things hiding in this park — things just as interesting as this fluffy puff ball!"
> 3. *(wait 2s)* *(gentle, inviting)* "This dandelion is so round and soft — like a tiny cloud on a stick! I have a fun idea — let's see what other interesting things we can find in this park!"
>
> **Screen**: Dandelion photo centered with a gentle glowing halo around the seed head. Tiny animated seed wisps drift slowly off the edges. A soft shimmer highlights the round, fluffy shape — a visual callback to the earlier conversation.
...
| 2 | Hook Rule Compliance | PASS | Both bridges open with emotional resonance — warm start builds on earlier wonder ("You noticed how round and fluffy..."), cold start opens with breathless wonder ("a tiny cloud sitting on a stick!"). Neither tests knowledge. |
...
| 4 | Edge Case Coverage | PASS | All steps have 3 response branches. Step 3 includes a concrete "stuck branch" with specific locations (grass, bushes, berries, pebbles). "Unexpected" branches always validate first, then scaffold with specific detail prompts (e.g., "Does it look more like a ball, a hat, or a cloud?"). |
...
| 9 | Entity Mapping Alignment | PASS | Key Concepts Form + Connection. Theme = How the World Works (primary, 0.40) — dandelion seed dispersal is a natural process. Related Concepts: Structure, Diversity, Nature, Discovery (all designed). Vocabulary (fluffy, round, seed head, puff, texture) traces to T1 tier guidance. Warm start references appearance — shape and senses — texture dimensions. Anchors: appearance, senses, imagination. |
